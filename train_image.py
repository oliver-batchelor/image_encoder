...
from model import MLP, ResNet, SplitModules
...
def random_fourier(image_ids, mapping_size, num_layers=4):
  ...
  create_mlp = partial(ResNet, mapping_size, mapping_size, output_size=3, num_layers=num_layers)
...
def main():
  ...
  loaders = dataloaders(images, batch_size=4, samples=16*1024, epoch_size=128)
